...
namespace TravelBookingWebApi.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserTypeId = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    ManagerUserId = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    LoginId = table.Column<string>(type: "nvarchar(256)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JourneyRequests", x => x.RequestId);
                });
